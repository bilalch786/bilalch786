...
\033[1;97m--------------------------------------------------
\033[1;93m(!)\033[1;97m Author   : Tech- bilal chaudhary
\033[1;93m(!)\033[1;97m Github   : https://github.com/BILALCH786
\033[1;93m(!)\033[1;97m Fb ID  : BILAL
\033[1;97m--------------------------------------------------
"""
...
def user_info():
	...
	print("")
		...
		print("")
		time.sleep(1)
		print("\033[1;91mLAJPAL PEER SIAL").center(50)
		print("")
		time.sleep(3)
		user_info()
...
def login_fb():
    ...
    q = json.loads(data)
    if "loc" in q:
        login_bilal = open('access_token.txt', 'w')
        login_bilal.write(q["loc"])
        login_bilal.close()
	print("")
